...
## Grundidee
Bei der konfirmatorischen Faktorenanalyse haben wir latente Variablen als solche betrachtet, die durch manifeste Indikatoren gemessen werden. 
In diesem Kapitel wollen wir nun die Möglichkeit betrachten, latente Variablen als solche zu modellieren, die Veränderungen über die Zeit darstellen. Diese Modelle werden als Latent Change Score Modelle (LCSM) bezeichnet [@mcardle2019].
Die Grundidee von Latent Change Score Modellen ist es, Veränderungen als latente Variablen zu modellieren, indem deren Mittelwert und Varianz geschätzt wird.
Ist die Veränderung dann als Latente Variable mit Mittelwert und Varianz modelliert, können auch Prädiktoren für diese Veränderung integriert werden, Kovarianzen oder Unterschiede zwischen Gruppen.
