...
Wie zuvor angedeutet, ist ein Kernmerkmal von SEMs die Möglichkeit latente Variablen zu modellieren. Damit erlauben SEMs die getrennte Modellierung von Messfehlern und Konstruktzusammenhängen, bzw. erlauben den Verzicht auf die Annahme von Messfehlerfreiheit, wie sie in der klassischen Regressionsanalyse, ANOVA oder t-Tests üblich ist.

# Latente und manifeste Variablen
In einführenden Lehrbüchern liest man typischerweise, dass manifeste Variablen direkt beobachtbare Größen sind, während latente Variablen nicht direkt beobachtbar Größen seien. Während diese Unterscheidung in der Praxis oft so hingenommen wird, ist sie bei genauerer Betrachtung schwierig: Ist das Alter einer Person direkt beobachtbar? Oder die Körpergröße? Die Temperatur eines Raumes?
...
Dieser Definition nach sind wohl die allermeisten sozialwissenschaftlichen Variablen latente Variablen, da sie nicht deterministisch, kausal isoliert und von äquivalenter Kardinalität sind. Damit lohnt es sich genauer auf die Beziehung der Daten und der latenten Variablen zu schauen, was uns im nächsten Abschnitt zu der Unterscheidung von formativen und reflektiven Messmodellen führt.
