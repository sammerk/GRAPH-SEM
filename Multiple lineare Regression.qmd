...
Die algebraische Notation der einfachen linearen Regression kann durch die Aufnahme weiterer $b_j \cdot x_{ji}$ Terme leicht zur Notation der multiplen linearen Regression ausgebaut werden. Weiterhin wird jedoch nur ein Term für das Residuum benötigt, da dies den Abstand parallel zur Achse der abhängigen Variable eines Datenpunktes und der Regressionsebene darstellt.
